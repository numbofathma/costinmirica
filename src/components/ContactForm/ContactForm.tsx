...
class ContactFrom extends React.Component<any, ContactFormState> {
    ...
    public render() {
        ...
        const contactForm = <Form onSubmit={this.sendEmail}>
            <Row>
                <h1>Getting in touch is easy!</h1>
                <p>Interested in working together or hire me? Drop me a line and let's start to create awesome
                    stuff!</p>
            </Row>
            <Row>
                <Column cols={6}>
